...
dotnet test Tests/Deltempo.Tests/Deltempo.Tests.csproj -c Release --no-build --filter "Category!=Benchmark" --logger "trx;LogFileName=deltempo_tests.trx" --blame-hang-timeout 2m --blame-hang-dump-type mini %*
